    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Yosh kitobxon'), (2, 'Tajribali kitobxon'), (3, 'Qadrdon kitobxon'), (4, 'Buyuk kitobxon')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_book_file', models.FileField(blank=True, null=True, upload_to='media/audio_book/')),
                ('electron_book', models.BooleanField(default=False)),
                ('electron_book_file', models.FileField(blank=True, null=True, upload_to='media/electron_book/')),
